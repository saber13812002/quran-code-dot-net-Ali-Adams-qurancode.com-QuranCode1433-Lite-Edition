...
namespace Model
{
    public class Book
    {
        ...
        {
            Dictionary<int, Dictionary<string, int>> letter_frequencies_in_books = new Dictionary<int, Dictionary<string, int>>();
            Dictionary<int, Dictionary<string, int>> word_frequencies_in_books = new Dictionary<int, Dictionary<string, int>>();
            Dictionary<int, Dictionary<string, int>> verse_frequencies_in_books = new Dictionary<int, Dictionary<string, int>>();
            ...
            Dictionary<string, int> letter_frequencies_in_book = new Dictionary<string, int>();
            Dictionary<string, int> word_frequencies_in_book = new Dictionary<string, int>();
            Dictionary<string, int> verse_frequencies_in_book = new Dictionary<string, int>();
            letter_frequencies_in_books.Add(this.Number, letter_frequencies_in_book);
            word_frequencies_in_books.Add(this.Number, word_frequencies_in_book);
            verse_frequencies_in_books.Add(this.Number, verse_frequencies_in_book);
            foreach (Chapter chapter in this.Chapters)
            {
                ...
                foreach (Verse verse in chapter.Verses)
                {
                    ...
                    if (verse_frequencies_in_book.ContainsKey(verse_text))
                    {
                        verse_frequencies_in_book[verse_text]++;
                        verse.OccurrenceInBook = verse_frequencies_in_book[verse_text];
                    }
                    else
                    {
                        verse_frequencies_in_book.Add(verse_text, 1);
                        verse.OccurrenceInBook = 1;
                    }
                    ...
                    foreach (Word word in verse.Words)
                    {
                        ...
                        if (word_frequencies_in_book.ContainsKey(word_text))
                        {
                            word_frequencies_in_book[word_text]++;
                            word.OccurrenceInBook = word_frequencies_in_book[word_text];
                        }
                        else
                        {
                            word_frequencies_in_book.Add(word_text, 1);
                            word.OccurrenceInBook = 1;
                        }
                        ...
                        foreach (Letter letter in word.Letters)
                        {
                            ...
                            if (letter_frequencies_in_book.ContainsKey(letter_text))
                            {
                                letter_frequencies_in_book[letter_text]++;
                                letter.OccurrenceInBook = letter_frequencies_in_book[letter_text];
                            }
                            else
                            {
                                letter_frequencies_in_book.Add(letter_text, 1);
                                letter.OccurrenceInBook = 1;
                            }
                        }
                    }
                }
            ...
            foreach (Chapter chapter in this.Chapters)
            {
                foreach (Verse verse in chapter.Verses)
                {
                    ...
                    if (verse_frequencies_in_books[this.Number].ContainsKey(verse_text))
                    {
                        verse.FrequencyInBook = verse_frequencies_in_books[this.Number][verse_text];
                    }
                    ...
                    foreach (Word word in verse.Words)
                    {
                        ...
                        if (word_frequencies_in_books[this.Number].ContainsKey(word_text))
                        {
                            word.FrequencyInBook = word_frequencies_in_books[this.Number][word_text];
                        }
                        ...
                        foreach (Letter letter in word.Letters)
                        {
                            ...
                            if (letter_frequencies_in_books[this.Number].ContainsKey(letter_text))
                            {
                                letter.FrequencyInBook = letter_frequencies_in_books[this.Number][letter_text];
                            }
                        }
                    }
                }
